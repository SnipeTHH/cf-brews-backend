    ...
    try {
        ...
        if (results.len() > 0) {
            try {
                ...
                writeLog(file="cfbrews_error", text="Graph Summary Error: #ae.message#");
                aiSummary = "Profile summary temporarily unavailable.";
            }
        } else {
        ...
        writeOutput(serializeJson({ "success": false, "error": "Graph analytics unavailable." }));
    }
</cfscript>
