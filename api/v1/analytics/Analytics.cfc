    ...
    */
    public struct function getBatchSummaryNoColumnar() {
        ...
        try {
            ...
            writeLog(file="cfbrews_error", text="Analytics getBatchSummaryNoColumnar Error: #e.message# #e.detail#");
            response = {
                "success": false,
    ...
    public struct function getBatchSummary() {
        ...
        try {
            ...
            writeLog(file="cfbrews_error", text="Analytics getBatchSummary Error: #e.message# #e.detail#");
            response = {
                "success": false,
                "message": "Analytics query failed."
            };
    ...
    public struct function getBatchSummaryExplain() {
        ...
        try {
            ...
            writeLog(file="cfbrews_error", text="Analytics getBatchSummaryExplain Error: #e.message# #e.detail#");
            response = {
                "success": false,
                "message": "Analytics explain query failed."
            };
        }
    ...
    public struct function getBatchSummaryNoColumnarExplain() {
        ...
        try {
            ...
            writeLog(file="cfbrews_error", text="Analytics getBatchSummaryNoColumnarExplain Error: #e.message# #e.detail#");
            response = {
                "success": false,
                "message": "Analytics explain query failed."
            };
